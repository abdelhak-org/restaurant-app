    ...
    <section id="gallery" className="section-shell scroll-mt-28 py-18 md:py-24">
      <div className="mb-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="space-y-3">
          ...
          <h2 className="balanced-text max-w-3xl font-serif text-5xl text-foreground sm:text-6xl lg:text-5xl">
      ...
      <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="section-card flex flex-col overflow-hidden rounded-[2.2rem] p-3">
          <div className="relative aspect-5/4 overflow-hidden rounded-[1.7rem] lg:aspect-auto lg:flex-1">
            <Image
